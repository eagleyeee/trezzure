	...
	>
		<div class="relative flex flex-row justify-between">
			...
			<div class="splide__arrows absolute right-0 mt-[15px] flex h-6 w-12 flex-row">
				<button class="splide__arrow splide__arrow--prev arrow-override" aria-label="control-left">
					<span class="icon-[hugeicons--arrow-left-01]"></span>
				</button>
				<button class="splide__arrow splide__arrow--next arrow-override" aria-label="control-right">
